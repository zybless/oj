...
import PlusMember from "@/views/oj/user/PlusMember.vue";
...
import RepoList from "@/views/oj/repo/RepoList.vue";
import ChooseExamList from "@/views/oj/chooseExam/ChooseExamList.vue";
import RepoDetail from "@/views/oj/repo/RepoDetail.vue";
import RepoHistory from "@/views/oj/repo/RepoHistory.vue";
import RepoProblemList from "@/views/oj/repo/RepoProblemList.vue";
...
import ChooseExamDetails from "@/views/oj/chooseExam/ChooseExamDetails.vue";
...
import TrainingExamList from "@/views/oj/training/TrainingExamList.vue";
import TrainingExamProblemList from "@/views/oj/training/TrainingExamProblemList.vue";
import TrainingExamHistory from "@/views/oj/training/TrainingExamHistory.vue";
...
import AnnouncementDetail from "@/views/oj/announcement/index.vue";
import CourseList from "@/views/oj/course/CourseList.vue";
import CourseDetail from "@/views/oj/course/CourseDetail.vue";
import NewLogin from "@/views/oj/NewLogin.vue";
import NewLogin2 from "@/views/oj/NewLogin2.vue";
import NewLogin3 from "@/views/oj/NewLogin3.vue";
import NewLogin4 from "@/views/oj/NewLogin4.vue";
import IntenseTraining from "@/views/oj/intenseTraining/index.vue";
import TrainCampInfo from "@/views/oj/intenseTraining/train.vue";
const ojRoutes = [
  {
    path: "/",
    redirect: "/home",
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        path: "paper/:repoID",
        component: TrainingExamProblemList,
        meta: { title: "Training Exam Problem List" },
      },
      {
        name: "TrainingExamHistory",
        path: "paperhistory/:repoID",
        component: TrainingExamHistory,
        meta: { title: "Training Exam History" },
      },
      {
  ...
  {
    path: "/intenseTraining",
    name: "IntenseTraining",
    component: IntenseTraining,
    meta: { title: "IntenseTraining" },
  },
  {
  ...
  },
  {
    ...
    component: RepoProblemList,
    meta: { title: "RepoProblemList" },
  },
  {
  ...
  },
  {
    ...
    path: "/chooseExam/:chooseExamID/",
    component: ChooseExamDetails,
    meta: { title: "ChooseExam Details", requireAuth: true },
    children: [
      {
  ...
  },
  {
    ...
    meta: { requireAuth: true, title: "PlusMember" },
  },
  {
    name: "Logout",
    path: "/logout",
  ...
  {
    path: "/traincampinfo/:id",
    name: "TrainCampInfo",
    meta: { title: "TrainCampInfo" },
    component: TrainCampInfo,
  },
  {
  ...
  },
  {
    ...
    meta: { title: "Announcement Details", access: "announcement" },
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          {
            name: "GroupTrainingExamList",
            path: "papers",
            component: TrainingExamList,
            meta: { title: "Group Exam Problem" },
          },
          {
            name: "GroupTrainingExamProblemList",
            path: "paper/:repoID",
            component: TrainingExamProblemList,
            meta: { title: "Group Training Exam Problem List" },
          },
          {
            name: "GroupTrainingExamHistory",
            path: "paperhistory/:repoID",
            component: TrainingExamHistory,
            meta: { title: "Group Training Exam History" },
          },
          {
