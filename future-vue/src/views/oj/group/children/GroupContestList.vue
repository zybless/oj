    ...
    <div class="filter-row">
      <el-row>
        ...
        <el-col
          ...
          :xs="24"
          v-else-if="
            (isAdmin || isGroupAdmin) && (editProblemPage || createProblemPage)
          "
        >
          <el-button
        ...
        <el-col
          :md="18"
          :xs="24"
          v-else-if="(isAdmin || isGroupAdmin) && announcementPage"
        >
          <el-button
            type="primary"
            size="small"
        ...
        >
          <el-row type="flex" justify="space-between" align="middle">
            <el-col :xs="10" :sm="4" :md="3" :lg="2">
              <img
                v-if="contest.image && contest.image != ''"
                class="trophy"
                :src="contest.image"
                width="95px"
              />
              <img
                v-else-if="contest.type == 0"
                class="trophy"
                :src="acmSrc"
                width="95px"
              />
