      ...
      <template v-else>
        <el-col :md="18" :xs="24" style=" margin-bottom: 10px;">
          ...
          <el-card v-show="$route.name === 'GroupDetails'">
            <el-row>
              <el-col
                :md="isGroupMember || isAdmin ? 12 : 24"
                :sm="24"
                :xs="24"
              >
              ...
              <el-col v-if="isGroupMember || isAdmin" :md="1" :lg="1">
                <div class="separator hidden-sm-and-down"></div>
                <p></p>
              </el-col>
              <el-col
                v-if="isGroupMember || isAdmin"
                :md="11"
                :sm="24"
                :xs="24"
              >
        ...
        <el-col :md="6" :xs="24" style="margin-bottom: 10px;">
          <el-card>
            ...
            <div style="text-align: center">
              <span v-if="isGroupOwner || isAdmin">
