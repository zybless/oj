    ...
    <div class="card-top">
      <el-tabs @tab-click="tabClick" v-model="route_name">
        ...
        <el-tab-pane
          lazy
          :disabled="trainingMenuDisabled"
          :name="groupID ? 'GroupTrainingExamList' : 'TrainingExamList'"
        >
          <span slot="label"
            ><i class="fa fa-list" aria-hidden="true"></i>&nbsp;试卷列表</span
          >
          <transition name="el-zoom-in-bottom">
            <router-view v-if="route_name === 'TrainingExamList'||route_name === 'GroupTrainingExamList'"></router-view>
          </transition>
        </el-tab-pane>
        <el-tab-pane
...
export default {
  ...
  created() {
    ...
    if (gid) {
      ...
      if (this.route_name == "TrainingExamProblemList") {
        this.route_name = "TrainingExamList";
      }
      if (this.route_name == "TrainingExamHistory") {
        this.route_name = "TrainingExamList";
      }
    }
  ...
  watch: {
    $route(newVal) {
      ...
      if (this.groupID) {
        ...
        if (newVal.name == "GroupTrainingExamProblemList") {
          this.route_name = "GroupTrainingExamList";
        }
        if (newVal.name == "GroupTrainingExamHistory") {
          this.route_name = "GroupTrainingExamList";
        }
      } else {
        ...
        if (newVal.name == "TrainingExamProblemList") {
          this.route_name = "TrainingExamList";
        }
        if (newVal.name == "TrainingExamHistory") {
          this.route_name = "TrainingExamList";
        }
      }
