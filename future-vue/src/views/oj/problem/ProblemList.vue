        ...
        (res) => {
          ...
          for (let x = 0; x < tidLen; x++) {
            for (let y = 0; y < tagLen; y++) {
              let tmpTagAndClassification = this.tagsAndClassificationList[y]
                .tagList;
