<template>
  <div>
    ...
    <el-card style="margin-top:15px">
      <div slot="header">
        <span class="panel-title home-title">其他</span>
      </div>
      <el-form label-position="top" :model="otherConfig">
        <el-row :gutter="20">
          <el-col :md="12" :xs="24">
            <el-form-item
              label="课程直播链接"
...
import {updateLiveStream,getLiveStream} from '@/common/newApi/user/index'
export default {
  name: 'SystemConfig',
  data() {
    return {
  ...
  methods: {
    saveLiveurl(){
      updateLiveStream(this.otherConfig.liveUrl).then((res)=>{
