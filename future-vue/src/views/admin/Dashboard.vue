  ...
  <div>
    ...
    <el-card style="margin-top:10px">
      ...
      <vxe-table stripe auto-resize :data="judgeInfo" align="center">
        ...
        <vxe-table-column
          min-width="110"
          field="percentDiskLoad"
          :title="$t('m.Disk_Usage')"
        >
        </vxe-table-column>
    ...
    <el-card style="margin-top:10px">
      <div slot="header">
        <span class="panel-title home-title">常用功能</span>
      </div>
      <el-dialog title="提示" :visible.sync="dialogVisible" width="30%">
        <span>排行榜将于每日夜间自动更新，不建议频繁手动更新，是否继续？</span>
        <span slot="footer" class="dialog-footer">
          <el-button @click="dialogVisible = false">取 消</el-button>
          <el-button type="primary" @click="updateRanking" :loading="loading"
            >确 定</el-button
          >
        </span>
      </el-dialog>

      <el-button @click="dialogVisible = true">更新排行榜</el-button>
    </el-card>
  </div>
</template>
...
import { updateRankingList } from "@/common/newApi/honorroll/index";
export default {
  name: "dashboard",
  components: {
    InfoCard,
  ...
  computed: {
    ...mapGetters(["userInfo", "isSuperAdmin", "isAdmin"]),
    https() {
