export const m = {
  ...
  Search_Training: '搜索题单',
  Training_Public: '公开题单',
  Training_Private: '私有题单',
  ...
  Training_Introduction: '题单简介',
  Training_Number: '题单编号',
  Training_Auth: '题单权限',
  Training_Total_Problems: '总题数',
  Record_List: '记录榜单',
  To_Enter_Training_Need_Password: '请输入该私有题单的密码，方可进入',
  Enter_the_training_password: '请输入私有题单的密码',  
  Register_training_successfully: '验证题单密码成功！',
  ...
  Back_To_Admin_Training_List:'返回作业管理列表',
  Back_To_Training_List:'返回作业列表',
  Back_Admin_Training_Problem_List:'返回作业题目管理列表',
