export const m = {
  ...
  Problem_Admin: "OJProblem",
  Problem_List: "OJProblem List",
  Create_Problem: "Create OJProblem",
  Admin_Group_Apply_Problem: "Group OJProblem Examine",
  Export_Import_Problem: "Export | Import OJProblem",
  ...
  Common_Problem_Admin: "Common Problem",
  Common_Problem_List: "Common Problem List",
  Create_Common_Problem: "Create Common Problem",
  ...
  Import_User_Tips2:
    "There are seven columns of data: username, password, email, realname and gender. The username and password cannot be empty, others can be enmpty, otherwise the data in this row may fail to be imported.",
  Import_User_Tips3:
    'The first line does not need to write the seven column names ("username", "password", "email","realname","gender","nickname","school").',
  Import_User_Tips4:
  ...
  Training_Exam_List: 'Training Exam List',
  System_Honor: "System Honor",
};
