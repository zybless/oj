export const m = {
  ...
  Problem_List: "题目列表",
  Create_Problem: "增加题目",
  Admin_Group_Apply_Problem: "班级题目审批",
  Export_Import_Problem: "导入|导出题目",
  Training_Admin: "题单管理",
  Training_List: "题单列表",
  Create_Training: "创建题单",
  Admin_Category: "分类管理",
  Contest_Admin: "比赛管理",
  Contest_List: "比赛列表",
  Create_Contest: "创建比赛",
  ...
  Import_User_Tips3:
    '第一行不必写(“用户名”，“密码”，“邮箱”，"真实姓名"，“性别”，“昵称”，“学校”)这七个列名',
  Import_User_Tips4:
  ...
  Open_Group_Discussion: "是否开启班级评论区",
  ...
  Update_Time: "更新时间",
  Order_Number: "序号",
  View_Training_Problem_List: "查看题单题目列表",
  Delete_Training_Tips: "此操作将删除该题单提交记录、榜单等数据, 是否继续?",

  // /views/admin/training/Training.vue
  Training_rank: "题单排序编号(升序)",
  Training_Title: "题单标题",
  Training_Description: "题单描述",
  Training_Auth: "题单权限",
  Training_Category: "题单分类",
  Public_Training: "公开题单",
  Private_Training: "私有题单",
  Training_Password: "题单密码",
  Edit_Training: "编辑题单",
  Redirect_To_Category: "当前题单的分类列表为空，请先前往创建分类！",
  Redirect: "重定向",

  // /views/admin/training/TrainingProblemList.vue
  Training_Problem_List: "题单题目列表",
  Add_Training_Problem: "添加题单题目",
  Remove_Training_Problem_Tips: "你是否确定要将该题目移出题单？",
