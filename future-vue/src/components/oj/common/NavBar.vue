  ...
  <div>
      ...
      <div>
        ...
        >
          ...
          <template v-if="mode == 'defalut'">
            ...
            >
            <el-menu-item index="/chooseExam"
              ><i class="el-icon-edit-outline"></i>备赛</el-menu-item
            >
            <!-- <el-menu-item index="/repo"
              ><i class="el-icon-edit-outline"></i>考试</el-menu-item
            > -->
            <el-menu-item index="/course"
              ><i class="el-icon-menu"></i>课程</el-menu-item
            >
            <el-menu-item index="/intenseTraining"
              ><i class="el-icon-s-flag"></i>集训队</el-menu-item
            >
            ...
            >
            <!-- <el-menu-item @click="jumpToScratch"
              ><i class="el-icon-s-opportunity"></i
              ><span class="scratch">scratch</span></el-menu-item
            > -->
    ...
    <template v-else>
      <div style="top:0px;left:0px;">
        ...
        <mu-drawer :open.sync="opendrawer" :docked="false" :right="false">
          ...
          >
            <mu-list-item-action>
              <mu-icon value=":el-icon-edit-outline" size="24"></mu-icon>
            </mu-list-item-action>
    ...
    <div v-if="showGif">
      ...
      <div class="celebration-container">
        <img :src="dialogImageUrl" alt="节日庆祝" class="celebration-gif" />
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  beforeUpdate() {
    ...
    if (showGif !== null) {
      this.showGif = showGif === "true"; // 将字符串转换为布尔值
      setTimeout(() => {
        this.showGif = false
      }, 3000);
    } else {
      this.showGif = false; // 如果 cookie 不存在
    }
  },
  ...
  data() {
    return {
      ...
      showGif: false,
      dialogImageUrl: require("@/assets/bianpao.gif"),
    };
  },
  methods: {
