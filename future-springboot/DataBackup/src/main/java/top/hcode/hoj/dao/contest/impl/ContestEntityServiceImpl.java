...
public class ContestEntityServiceImpl extends ServiceImpl<ContestMapper, Contest> implements ContestEntityService {
    ...
    @Override
    public List<ContestVO> getRecentContest(Integer pastDays, Integer futureDays) {
        List<ContestVO> contestList = contestMapper.getRecentContest(pastDays, futureDays);
        return contestList;
    }
