...
public class TrainingController {
    ...
    @RequiresAuthentication
    public CommonResult<Map<String, Object>> getTrainingRank(@RequestParam(value = "tid", required = true) Long tid,
     ...
     * @Since 2021/11/20
     */
    @GetMapping("/get-training-exam-list")
    @RequiresAuthentication
    public CommonResult<List<ExamRepoVO>> getTrainingExamList(@RequestParam(value = "tid") Long tid) {
        return trainingService.getTrainingExamList(tid);
    }
