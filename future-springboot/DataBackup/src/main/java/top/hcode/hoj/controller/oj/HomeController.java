...
public class HomeController {
    ...
    public CommonResult<AnnouncementVO> getAnnouncementById(
            @RequestParam(value = "id", defaultValue = "false") Long id) {
        return CommonResult.successResponse(announcementEntityService.getAnnouncementById(id));
    }

    @GetMapping("/get-ranking-list")
    public CommonResult<RankingListVO> getRankingList() {
        return homeService.getRankingList();
    }

    @GetMapping("/get-month-ranking")
    public CommonResult<MonthRankingVO> getMonthRanking() {
        return homeService.getMonthRanking();
    }
}
