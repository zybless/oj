...
public class AdminUserController {
    ...
    @RequiresPermissions("user_admin")
    @RequiresAuthentication
    public CommonResult<Void> addVip(@RequestParam String uuid, @RequestParam String date) {
        return adminUserService.addVip(uuid, date);
    }

    @DeleteMapping("/remove-vip")
    @RequiresPermissions("user_admin")
    @RequiresAuthentication
    public CommonResult<Void> removeVip(@RequestParam String uuid) {
        return adminUserService.removeVip(uuid);
    }
