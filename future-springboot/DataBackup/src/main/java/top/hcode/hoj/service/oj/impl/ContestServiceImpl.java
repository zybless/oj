...
public class ContestServiceImpl implements ContestService {
    ...
    @Override
    public CommonResult<Void> startContest(Long cid) {
        try {
            contestManager.startContest(cid);
            return CommonResult.successResponse();
        } catch (StatusFailException e) {
            return CommonResult.errorResponse(e.getMessage());
        } catch (StatusForbiddenException e) {
    ...
    @Override
    public CommonResult<Date> getContestStartTime(Long cid) {
        try {
            return CommonResult.successResponse(contestManager.getContestStartTime(cid));
        } catch (StatusFailException e) {
            return CommonResult.errorResponse(e.getMessage());
        }
    }
