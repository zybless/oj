    ...
    public List<JSONObject> getJudgeServiceInfo() {
        ...
        for (ServiceInstance serviceInstance : serviceInstances) {
            try {
                ...
                jsonObject.set("freeDisk", df.format(diskInfo.getFreeDisk()) + "GB");
                jsonObject.set("totalDisk", df.format(diskInfo.getTotalDisk()) + "GB");
                jsonObject.set("percentDiskLoad", df.format(diskInfo.getUsagePercentage()) + "%");
