...
public class ContestController {
    ...
    @RequiresAuthentication
    public CommonResult<Void> startContest(@RequestParam(value = "cid", required = true) Long cid) {
        return contestService.startContest(cid);
    }

    @GetMapping("/get-contest-start-time")
    @RequiresAuthentication
    public CommonResult<Date> getContestStartTime(@RequestParam(value = "cid", required = true) Long cid) {
        return contestService.getContestStartTime(cid);
    }
