...
//        String filePath = folder.getAbsolutePath() + File.separator + file.getOriginalFilename();
//        try {
...
//        }
        ...
        ProblemIoRecord problemIoRecord = new ProblemIoRecord();
        problemIoRecord.setModifiedUser(userRolesVo.getUsername());
        problemIoRecord.setModifiedUserId(userRolesVo.getUid());
        problemIoRecord.setType(0);
        problemIoRecordEntityService.save(problemIoRecord);
    }
