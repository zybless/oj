...
public interface FileEntityService extends IService<File> {
    ...
    int updateFileToDeleteByCidAndType(Long courseId, String type);
    ...
    List<List<String>> getExamRankExcelHead(Integer problemSize);
    ...
    List<List<Object>> changeExamRankToExcelRowList(List<ExamRankVO> examRankVOList);
