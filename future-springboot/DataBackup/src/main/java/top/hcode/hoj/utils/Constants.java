...
public class Constants {
    ...
    public enum Account {
        ...
        ADMIN_UID_LIST_CACHE("admin_uid_list_case"),
    ...
    public enum File {
        ...
        COURSE_IMG_FOLDER("/hoj/file/course/img"),


        CONTEST_IMG_FOLDER("/hoj/file/contest/img"),

        TRAINING_CAMP_IMG_FOLDER("/hoj/file/trainingcamp/img"),

        DEFAULT_IMG_FOLDER("/hoj/file/default/img"),
        ...
        PROBLEM_TMP_FOLDER("/hoj/file/problem/tmp"),
    ...
    public enum Training {
        ...
        AUTH_PUBLIC("Public"),
        RANKING_LIST_KEY("home_ranking_list"),
        MONTH_RANKING_KEY("home_month_ranking"),
        USER_ACNUM_KEY("user_acnum_key");
    ...
    public enum RedisKey {
        JUDGE_SERVER_INFO("judge_server_info");
