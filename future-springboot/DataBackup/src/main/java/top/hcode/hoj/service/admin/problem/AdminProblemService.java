...
public interface AdminProblemService {
    ...
    CommonResult<IPage<ProblemIoRecord>> getProblemIoRecord(Integer limit, Integer currentPage, String keywords);

    CommonResult<Void> addProblemBatchWithZip(MultipartFile[] files, String prefix, Integer number);
}
