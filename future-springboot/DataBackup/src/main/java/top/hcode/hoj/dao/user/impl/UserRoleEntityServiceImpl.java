...
//        ((LogoutAware) authc).onLogout((SimplePrincipalCollection) attribute);
    ...
    private final static List<String> EnglishRole = Arrays.asList("Super Administrator", "General Administrator",
            ...
            "Normal User(No Submission & Forbidden Words)", "Problem Administrator", "Teacher");
    ...
    @Override
    public int deleteVip(String uid) {
        QueryWrapper<UserRole> userRoleQueryWrapper = new QueryWrapper<>();
        userRoleQueryWrapper.eq("uid", uid).eq("role_id", 1010L);
        return userRoleMapper.delete(userRoleQueryWrapper);
    }
}
