...
public class ImageServiceImpl implements ImageService {
    ...
    @Override
    public CommonResult<String> uploadCourseImg(MultipartFile image, Long courseId) {
        try {
            return CommonResult.successResponse(imageManager.uploadCourseImg(image, courseId));
        } catch (StatusFailException e) {
            return CommonResult.errorResponse(e.getMessage());
        } catch (StatusSystemErrorException e) {
            return CommonResult.errorResponse(e.getMessage(), ResultStatus.SYSTEM_ERROR);
    ...
    @Override
    public CommonResult<String> uploadContestImg(MultipartFile image, Long contestId) {
        try {
            return CommonResult.successResponse(imageManager.uploadContestImg(image, contestId));
        } catch (StatusFailException e) {
            return CommonResult.errorResponse(e.getMessage());
        } catch (StatusSystemErrorException e) {
            return CommonResult.errorResponse(e.getMessage(), ResultStatus.SYSTEM_ERROR);
    ...
    @Override
    public CommonResult<String> uploadTrainingCampImg(MultipartFile image, Long trainingCampId) {
        try {
            return CommonResult.successResponse(imageManager.uploadTrainingCampImg(image, trainingCampId));
        } catch (StatusFailException e) {
            return CommonResult.errorResponse(e.getMessage());
        } catch (StatusSystemErrorException e) {
            return CommonResult.errorResponse(e.getMessage(), ResultStatus.SYSTEM_ERROR);
    ...
    @Override
    public CommonResult<String> uploadImg(MultipartFile image) {
        try {
            return CommonResult.successResponse(imageManager.uploadImg(image));
        } catch (StatusFailException e) {
            return CommonResult.errorResponse(e.getMessage());
        } catch (StatusSystemErrorException e) {
            return CommonResult.errorResponse(e.getMessage(), ResultStatus.SYSTEM_ERROR);
    ...
    @Override
    public CommonResult<Void> deleteImg(String url) {
        try{
            imageManager.deleteImg(url);
