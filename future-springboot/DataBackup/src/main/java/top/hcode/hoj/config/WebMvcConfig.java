    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        ...
        registry.addResourceHandler(Constants.File.IMG_API.getPath() + "**", Constants.File.FILE_API.getPath() + "**")
                .addResourceLocations("file:" + Constants.File.USER_AVATAR_FOLDER.getPath() + File.separator,
                        ...
                        "file:" + Constants.File.DEFAULT_IMG_FOLDER.getPath() + File.separator,
                        "file:" + Constants.File.COURSE_IMG_FOLDER.getPath() + File.separator,
                        "file:" + Constants.File.CONTEST_IMG_FOLDER.getPath() + File.separator,
                        "file:" + Constants.File.TRAINING_CAMP_IMG_FOLDER.getPath() + File.separator);
    }
