...
public class AdminUserServiceImpl implements AdminUserService {
    ...
    @Override
    public CommonResult<Void> addVip(String uuid, String date) {
        try {
            adminUserManager.addVip(uuid, date);
            return CommonResult.successResponse();
        } catch (StatusFailException e) {
            return CommonResult.errorResponse(e.getMessage());
        }
    ...
    @Override
    public CommonResult<Void> removeVip(String uuid) {
        try {
            adminUserManager.removeVip(uuid);
            return CommonResult.successResponse();
        } catch (StatusFailException e) {
            return CommonResult.errorResponse(e.getMessage());
        }
