...
public class ProblemController {
    ...
    /**
     * @MethodName getUserGroupProblemStatus
     * @Description 获取用户班级题目列表中各个题目的做题情况
     * @Return CommonResult
     * @Since 2023/10/11
     */
    @RequiresAuthentication
    @PostMapping("/get-user-group-problem-status")
    public CommonResult<UserGroupProblemStatusVO> getUserGroupProblemStatus() {
        return problemService.getUserGroupProblemStatus();
    }
